...
System.register(["angular", "lodash", "app/core/config", "app/core/core"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var angular_1, lodash_1, config_1, core_1, datasourceTypes, defaults, datasourceCreated, DataSourceEditCtrl;
    return {
        setters: [
        ...
        execute: function () {///<reference path="../../headers/common.d.ts" />
            ...
            DataSourceEditCtrl = (function () {
                ...
                DataSourceEditCtrl.prototype.initNewDatasourceModel = function () {
                    this.current = angular_1.default.copy(defaults);
                ...
                DataSourceEditCtrl.prototype.typeChanged = function () {
                    ...
                    return this.backendSrv.get('/api/plugins/' + this.current.type + '/settings').then(function (pluginInfo) {
                        ...
                        console.log(_this.datasourceMeta);
