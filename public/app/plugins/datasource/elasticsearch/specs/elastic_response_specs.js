    ...
    return {
        ...
        execute: function () {
            common_1.describe('ElasticResponse', function () {
                ...
                common_1.describe('histogram response', function () {
                    var result;
                    common_1.beforeEach(function () {
                        targets = [{
                                refId: 'A',
                    ...
                    common_1.it('should return docs with byte and count', function () {
                        common_1.expect(result.data[0].datapoints.length).to.be(3);
                        common_1.expect(result.data[0].datapoints[0].Count).to.be(1);
                        common_1.expect(result.data[0].datapoints[0].bytes).to.be(1000);
                    });
                });
