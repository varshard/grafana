        ...
        execute: function () {///<reference path="../../../../headers/common.d.ts" />
            common_1.describe('grafanaGraph', function () {
                ...
                graphScenario('dashed lines options', function (ctx) {
                    ...
                    common_1.it('should configure dashed plot with correct options', function () {
                        common_1.expect(ctx.plotOptions.series.lines.show).to.be(true);
                        common_1.expect(ctx.plotOptions.series.dashes.lineWidth).to.be(2);
                        common_1.expect(ctx.plotOptions.series.dashes.show).to.be(true);
                    });
                });
